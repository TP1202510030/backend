...
import com.tp1202510030.backend.growrooms.domain.model.queries.crop.GetCurrentPhaseOfCropByCropIdQuery;
...
public interface CropQueryService {
    ...
    Optional<CropPhase> handle(GetCurrentPhaseOfCropByCropIdQuery query);
}
